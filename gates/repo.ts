...
allow("bench/checker/proofs_3200/why3.bend", 3000000);
allow("bench/checker/proofs_3200/compare.ts", 4000);
allow("bench/checker/proofs_3200/WHY3.md", 2500);
...
allow(/^demos\/why3_[a-z0-9_]+\/WHY3\.md$/, 1200);
...
allow("gates/auto.ts", 7000);
allow(/^gates\/(_lib|_run|perf|ping|repo|test|why3|demos)\.ts$/, 6000);
allow(/^tests\/[a-z]+\/[a-z0-9_]+\.bend$/, 16000);
allow(/^tests\/why3\/[a-z0-9_]+\.bend$/, 16000);
